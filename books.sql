...
CREATE TABLE `books` (
  ...
  `booksAuthor` varchar(255) DEFAULT NULL,
...
INSERT INTO `books` VALUES (1,'FIREFLY LANE','KRISTEN HANNAH','NOVEL'),(2,'STILL ALICE','LISA GENOVA','DRAMA'),(3,'DOING HARM','KELLY PARSONS','NOVEL');
...
-- Dump completed on 2016-06-05 13:40:21
